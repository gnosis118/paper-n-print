      ...
      <div className="bg-card border-b border-border px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <Button onClick={downloadPDF} className="bg-invoice-brand hover:bg-invoice-brand/90" size="sm">
              ...
              <TabsContent value="form" className="mt-0">
                <div className="bg-card border border-border rounded-lg p-4 shadow-soft">
                  ...
                  <div className="mb-6 pb-4 border-b border-border">
                    <label htmlFor="mobile-template-select" className="block text-sm font-medium mb-2">
                      Invoice Template
                    </label>
                    <Select
                      value={invoiceData.template}
                ...
                <div className="bg-card border border-border rounded-lg overflow-hidden shadow-soft">
                  ...
                  <div className="p-4">
                    <div id="invoice-preview">
                      <InvoicePreview data={invoiceData} showPaymentOptions={true} />
                    </div>
                  </div>
                </div>
              </TabsContent>
